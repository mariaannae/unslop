...
var index_default = {
  async fetch(request, env) {
	const corsHeaders = {
		'Access-Control-Allow-Origin': '*', // Temporarily '*' for testing; replace with your frontend URL in production
    ...
    const openai = new openai_default({
      ...
      baseURL: "https://gateway.ai.cloudflare.com/v1/4c6978cc2955d7ac74d9de5b674f23c3/openai-proxy/openai"
      // paste your AI Gateway endpoint here
    });
